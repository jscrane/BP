...
plot.dates <- function(bp, points, title, col, yl="mmHg") {
  cs <- c("green", "blue")
  dates <- bp$datetime
...
plot.dates(bp, bp$sys, "Systolic", "red")
plot.dates(bp, bp$dia, "Diastolic", "blue")
```
...
```{r}
plot.dates(bp, bp$pul, "Pulse", "green", "bpm")
```
